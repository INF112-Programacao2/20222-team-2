...
void Tabuleiro::moverPeca(int x, int y, int x2, int y2)
{
  ...
  if (_tabuleiro[x2][y2] == nullptr && _tabuleiro[x][y] != nullptr)
  { // Se a posição estiver sem nenhuma peça, o programa
  ...
  else if (_tabuleiro[x2][y2] != nullptr && _tabuleiro[x][y] != nullptr && _tabuleiro[x2][y2]->getCor() != _tabuleiro[x][y]->getCor())
  { // Se a posição estiver com uma peça de cor diferente, o programa
    _tabuleiro[x2][y2] = _tabuleiro[x][y];
